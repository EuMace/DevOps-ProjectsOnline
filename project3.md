...
1.	In creating frontend of To-Do app, use npx create-react-app client in same root directory as backend code, which is the Todo directory. This will creat a new folder in your Todo directory called client. The react code will go in there.
